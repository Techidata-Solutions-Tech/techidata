    ...
    <footer className="bg-black text-gray-400 py-12 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-center mb-6">
          <Link href="/">
            <div className="relative w-40 h-12  rounded-lg p-0.5">
        ...
        <Link href="/about-us" className="hover:text-white transition-colors">Home</Link>
          <Link href="/about-us" className="hover:text-white transition-colors">About Us</Link>
          <Link href="/about-us" className="hover:text-white transition-colors">Services</Link>
          <Link href="/about-us" className="hover:text-white transition-colors">Contact Us</Link>
        </nav>
        ...
        <div className="flex justify-center gap-6 mb-8">
          ...
          {/* Pinterest */}
          <Link href="https://pinterest.com" className="hover:text-white transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center">
          <p>© Techidata, Inc. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
