    ...
    <section className="py-24 bg-black text-white">
      <div className="container">
        ...
        <h2 className="text-6xl font-medium text-center mt-6">
          Where ideas get <span className="text-[#F3631F]">shape</span>
        </h2>
        <div className="mt-12 max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-6 gap-8 place-items-center">
            <FeatureCard
        ...
        <div className="mt-8 flex flex-wrap gap-3 justify-center">
          {features.map((feature) => (
            <div
              key={feature}
              className="bg-neutral-900 border border-white/10 inline-flex px-3 py-1.5 rounded-2xl gap-3 items-center  justify-center"
            >
              <span className="bg-lime-400 text-neutral-950 size-5 rounded-full flex items-center justify-center text-xl">
                &#10038;
              </span>
