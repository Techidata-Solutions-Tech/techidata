        ...
        {({ ref }) => (
          <div ref={ref} className="max-w-7xl mx-auto px-6 lg:px-12 py-16">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
              ...
              <div className={`lg:sticky top-24 self-start transition-all duration-700 ${animate ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                {[
                  ...
                  <div 
                    key={index} 
                    className={`bg-white rounded-xl shadow-md p-6 border border-gray-200 transition-all duration-700 ${animate ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
